export const BACKGROUND_OPTIONS = [
  ...
  ...Array.from({ length: 53 }, (_, i) => {
    ...
    const slotsMap = {
      ...
      12: [
        { id: "s1", x: 43,  y: 377, w: 55,  h: 48  },
        { id: "s2", x: 309, y: 379, w: 37,  h: 42  },
        { id: "s3", x: 309, y: 420, w: 37,  h: 40  },
        { id: "s4", x: 309, y: 461, w: 38,  h: 42  },
      ],
      13: [
        { id: "s1", x: 43,  y: 377, w: 61,  h: 59  },
      ...
      47: [
        { id: "s1", x: 317, y: 158, w: 108, h: 101, rotate: -10 },
        { id: "s2", x: 413, y: 188, w: 102, h: 93,  rotate: 6 },
      ],
      15: [
        { id: "s1", x: 53,  y: 377, w: 51,  h: 43  },
        { id: "s2", x: 319, y: 379, w: 31,  h: 37  },
        { id: "s3", x: 319, y: 420, w: 31,  h: 34  },
        { id: "s4", x: 319, y: 461, w: 32,  h: 37  },
      ],
      19: [
  ...
  { id: "bg-new-59", name: "Happy Birthday ver 15",   category: "Happy Birthday",     type: "pattern", value: "url('/samples/59.jpg')", thumbnail: "/samples/59.jpg", backgroundSize: "cover", slots: [], textFields: [] },
